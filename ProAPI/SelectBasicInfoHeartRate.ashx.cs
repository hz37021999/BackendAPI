...
{
    /// <summary>
    /// SelectBasicInfoHeartRate 的摘要说明
    /// </summary>
    public class SelectBasicInfoHeartRate : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        sbResult.Append("{\"ID\":" + dt.Rows[i]["ID"].ToString() + ",\"HeartRate\":\"" + dt.Rows[i]["HeartRate"].ToString() + "\",\"GetInfoTime\":\"" + dt.Rows[i]["GetInfoTime"].ToString() + "\",\"DeviceID\":\"" + dt.Rows[i]["DeviceID"].ToString() + "\"},");
                    }
