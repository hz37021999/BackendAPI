...
{
    /// <summary>
    /// SelectBasicInfoSpO2 的摘要说明
    /// </summary>
    public class SelectBasicInfoSpO2 : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        sbResult.Append("{\"ID\":" + dt.Rows[i]["ID"].ToString() + ",\"SpO2\":\"" + dt.Rows[i]["SpO2"].ToString() + "\",\"GetInfoTime\":\"" + dt.Rows[i]["GetInfoTime"].ToString() + "\",\"DeviceID\":\"" + dt.Rows[i]["DeviceID"].ToString() + "\"},");
                    }
